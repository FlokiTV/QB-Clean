local Translations = {
    error = {
        ...
        ["no_weapon"] = "Você não possui uma arma em suas mãos..",
    ...
    info = {
        ...
        ["check_discord"] = "🔸 Entrar no nosso Discord para mais informações: ",
        ["banned"] = "Foi banido:",
        ["ban_perm"] = "\n\nSeu ban é permanente.\n🔸 Entrar no nosso Discord para mais informações: ",
        ["ban_expires"] = "\n\nO ban expira em: ",
        ...
        ["server_restart"] = "Servidor reiniciado, verifique nosso Discord para mais informações: ",
